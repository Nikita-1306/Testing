...
st.title("🌍 Global Healthy Diet Cost Analysis Dashboard")
...
fig5 = px.pie(cat_data, names="cost_category", values="count")
st.plotly_chart(fig5, use_container_width=True)

# 6. Box Plot by Region
st.markdown("### 📦 Cost Distribution by Region")
fig6 = px.box(filtered_df, x="region", y="cost_healthy_diet_ppp_usd")
...
if not yearly_avg.empty and not regi_
